    ...
    <main className="min-h-screen bg-white">
      ...
      >
        <div className="mx-auto mb-10 mt-10 flex max-w-7xl flex-col gap-4">
          ...
          <div className="text-md md:text-xl">
            Karena semua datamu disimpan di HP kamu, penting banget buat kamu
            jaga keamanan HP. Pakai password atau kunci biar gak ada yang bisa
            akses data solatmu tanpa izin.
          </div>
          <div className="text-md font-bold md:text-xl">5. Hak Kamu</div>
          <div className="text-md md:text-xl">
            Data yang ada di Fatih sepenuhnya dalam kendali kamu. Mau hapus
            data? Gampang, tinggal hapus aplikasi dari HP, dan semua data lokal
            kamu otomatis hilang.
          </div>
          <div className="text-md font-bold md:text-xl">
            6. Update Kebijakan
          </div>
          <div className="text-md md:text-xl">
            Kami mungkin bakal update kebijakan ini dari waktu ke waktu. Kalo
            ada perubahan, kami bakal kasih tahu lewat aplikasi atau platform
            resmi. Jadi, keep an eye on it ya!
          </div>
        </div>
      </Reveal>
    </main>
